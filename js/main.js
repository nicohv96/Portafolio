...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    data.forEach((project, index) => {
      ...
      const firstTwoTechnologies = project.technologies
        .slice(0, 3)
    ...
    <div class="card-body">
      ...
      <div class="card-footer">
        ...
        <div class="content-buttons">
          <button class="btn btn-more" data-project='${JSON.stringify(
            project
          )}'>Leer más</button>
        </div>
      </div>
  ...
  fetch("https://formsubmit.co/ajax/25f0c332a0698e709cb0170b1e7ce8da", {
    ...
    .then((data) => {
      ...
      showToast(
        ...
        data.success === "false"
          ? "Hubo un error al enviar el formulario. Intentalo de nuevo."
